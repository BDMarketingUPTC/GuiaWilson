...
// **IMPORTANTE**: Reemplaza con tu URL de despliegue si no usas variables de entorno.
...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Opcional: restablecer a "idle" después de 5 segundos para que se pueda enviar otro mensaje
      // setTimeout(() => setSubmitStatus("idle"), 5000);
    }
  };

  const isSubmitting = submitStatus === "loading";
  /*const showForm = submitStatus !== "success"; // Mostrar formulario a menos que el estado sea 'success'*/
              ...
              <div className="lg:col-span-1">
                <div className="bg-[var(--neutral-gray)] rounded-xl shadow-lg p-6 sticky top-6">
                  ...
                  <div className="space-y-6">
                    {/* Secciones de contacto (Ubicación, Email, Teléfono, Horario) */}
              ...
              <div className="lg:col-span-2">
                <div className="bg-[var(--neutral-gray)] rounded-xl shadow-lg p-6 md:p-8">
                  ...
                  {submitStatus === "success" ? (
                    <div className="text-center py-20 bg-[var(--teal-accent)]/10 rounded-xl">
                      <Check className="w-16 h-16 text-[var(--teal-accent)] mx-auto mb-6" />
                      <h3 className="text-3xl font-extrabold text-[var(--teal-accent)] mb-4">
                        ¡Mensaje Enviado con Éxito!
                      </h3>
                      <p className="text-xl text-[var(--neutral-text-primary)] max-w-md mx-auto">
                        Agradecemos tu interés. Nuestro guía se pondrá en
                        contacto contigo muy pronto para planificar tu aventura.
                      </p>
                      <button
                        onClick={() => setSubmitStatus("idle")}
                        className="mt-6 bg-[var(--blue-primary)] hover:bg-[var(--blue-dark)] text-[var(--neutral-white)] font-medium py-2 px-6 rounded-full transition-colors"
                      >
                        Enviar otro mensaje
                      </button>
                    </div>
                    ...
                    <>
                      ...
                      {/* Formulario que se oculta al enviar con éxito */}
