      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-[var(--neutral-text-primary)] mb-4">
            <span className="text-[var(--blue-light)]">Galería</span>{" "}
            ...
            <button
              ...
              className={`flex items-center px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 ${
                activeFilter === category.id
                  ? "bg-[var(--blue-light)] text-[var(--neutral-white)] shadow-md border border-[var(--blue-light)]"
                  : "bg-[var(--neutral-gray)] text-[var(--neutral-text-secondary)] hover:bg-[var(--neutral-gray)]/80 hover:text-[var(--blue-light)] border border-[var(--neutral-gray)]"
              }`}
            >
        ...
        <div className="relative overflow-hidden w-full group">
          ...
          >
            <AnimatePresence>
              {filteredImages.map((img, index) => (
                ...
                >
                  <div className="relative group overflow-hidden rounded-2xl shadow-lg border border-[var(--neutral-gray)]">
          ...
          {totalSlides > displayCount && (
            <>
              <button
                onClick={handlePrev}
                className="absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 bg-[var(--neutral-white)]/50 text-[var(--blue-light)] rounded-full flex items-center justify-center shadow-lg hover:bg-[var(--neutral-white)]/80 transition-colors duration-300 z-20"
              >
                <ChevronLeft size={30} />
              </button>
              <button
                onClick={handleNext}
                className="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 bg-[var(--neutral-white)]/50 text-[var(--blue-light)] rounded-full flex items-center justify-center shadow-lg hover:bg-[var(--neutral-white)]/80 transition-colors duration-300 z-20"
              >
      ...
      <AnimatePresence>
        {selectedImage !== null && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-[var(--blue-dark)]/80 backdrop-blur-sm z-50 flex items-center justify-center p-4"
            onClick={closeModal}
          >
            <motion.div
            ...
            >
              <button
                onClick={closeModal}
                className="absolute top-4 right-4 z-10 p-2 text-[var(--neutral-white)]/80 hover:text-[var(--neutral-white)] transition-colors duration-300"
              >
                <X size={28} />
              </button>

              <div className="relative w-full h-[70vh] flex items-center justify-center bg-[var(--neutral-text-primary)]">
                <Image
                ...
                <button
                  ...
                  className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-[var(--neutral-white)]/20 text-[var(--neutral-white)] rounded-full flex items-center justify-center hover:bg-[var(--neutral-white)]/40 transition-colors z-10"
                >
                  <ChevronLeft size={24} />
                </button>
                <button
                  onClick={goToNextModal}
                  className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-[var(--neutral-white)]/20 text-[var(--neutral-white)] rounded-full flex items-center justify-center hover:bg-[var(--neutral-white)]/40 transition-colors z-10"
                >
                  <ChevronRight size={24} />
                </button>
              </div>

              <div className="p-6 bg-[var(--blue-light)] border-t border-[var(--teal-accent)]">
                <div className="flex justify-between items-start mb-2">
                  <h3 className="text-2xl font-bold text-[var(--neutral-white)] mb-2">
                    {filteredImages[selectedImage].title}
                  </h3>
                  <span className="text-sm font-semibold text-[var(--neutral-gray)] mt-1">
                    {selectedImage + 1} de {filteredImages.length}
                  </span>
                </div>
                <p className="text-[var(--neutral-white)] leading-relaxed mb-4">
                  {filteredImages[selectedImage].description}
                </p>
                <div className="flex justify-end">
                  <Link
                    href={`/galeria/${filteredImages[selectedImage].id}`}
                    className="inline-flex items-center text-sm font-medium text-[var(--teal-accent)] hover:text-[var(--aqua-lake)] transition-colors"
                    onClick={closeModal}
                  >
