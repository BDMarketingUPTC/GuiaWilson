...
export default function FAQ() {
  ...
  return (
    <section className="bg-[var(--neutral-white)] py-24 px-6 md:px-12 lg:px-24">
      {/* Encabezado */}
      <motion.div
        initial="hidden"
        whileInView="visible"
      ...
      >
        <div className="inline-flex items-center text-[var(--blue-primary)] font-medium text-sm mb-4 py-1.5 px-4 bg-[var(--blue-light)]/20 rounded-full border border-[var(--blue-light)]/30">
          <HelpCircle size={16} className="mr-2" />
          <span>Información Práctica</span>
        </div>
        <h2 className="text-4xl md:text-5xl font-bold text-[var(--neutral-text-primary)] mb-4">
          <span className="text-[var(--teal-accent)]">Preguntas</span>
          <span className="text-[var(--blue-primary)]"> Frecuentes</span>
        </h2>
      ...
      <div className="max-w-3xl mx-auto space-y-4">
        {faqData.map((faq, index) => (
          <motion.div
            ...
            variants={itemVariants}
            className="border border-[var(--neutral-gray)] rounded-xl bg-[var(--neutral-white)] shadow-sm hover:shadow-md transition-shadow"
          >
            <button
            ...
            >
              ...
              <ChevronDown
                className={`w-5 h-5 text-[var(--teal-accent)] transform transition-transform ${
            ...
            {openIndex === index && (
              <motion.div
                ...
                className="px-5 pb-5 text-[var(--neutral-text-secondary)]"
              >
                {faq.answer}
              </motion.div>
            )}
