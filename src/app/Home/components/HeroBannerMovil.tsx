...
const HeroBanner = () => {
  ...
  return (
    <section className="relative w-full overflow-hidden min-h-screen md:min-h-auto">
      <div className="flex flex-col md:flex-row h-full">
        ...
        <div className="relative w-full md:w-1/2 min-h-[50vh] md:min-h-screen flex-grow">
          ...
          <motion.button
            className="absolute top-1/2 left-1/4 transform -translate-x-1/2 -translate-y-1/2 w-16 h-16 md:w-20 md:h-20 rounded-full bg-[var(--neutral-white)]/30 backdrop-blur-sm cursor-pointer border border-[var(--neutral-white)]/50 flex items-center justify-center"
            onClick={() => setIsGuideModalOpen(true)}
            aria-label="Información del guía"
            animate={{ scale: [1, 1.1, 1] }}
            transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
          >
            <span className="absolute inset-0 rounded-full bg-[var(--neutral-white)]/50 animate-ping"></span>
            <div className="relative z-10 flex items-center justify-center text-[var(--neutral-white)] text-2xl font-bold">
              i
            </div>
          </motion.button>
        </div>
        ...
        <div className="relative z-10 w-full md:w-1/2 flex items-center justify-center p-6 md:p-12 lg:p-24 bg-[var(--neutral-white)] md:bg-transparent text-[var(--neutral-text-primary)] md:text-[var(--neutral-white)]">
          <div className="text-center md:text-left max-w-2xl">
            <motion.p
              className="text-base md:text-xl text-[var(--neutral-text-secondary)] md:text-[var(--neutral-white)] mb-8 leading-relaxed"
