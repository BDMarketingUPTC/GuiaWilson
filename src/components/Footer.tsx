...
import { X, Github, ChevronDown, Mail, Phone, Instagram } from "lucide-react";
...
const RESOURCE_LINKS: FooterLink[] = [
  { href: "/blog", text: "Blog" },
  { href: "/preguntas-frecuentes", text: "FAQs" },
...
const socialLinks = [
  ...
  },
  {
    ...
    label: "Facebook",
    icon: <Github size={20} />, // Nota: Se usó el icono de Github como placeholder, se puede cambiar
  },
];
  ...
  return (
    <footer className="bg-[var(--blue-dark)] text-[var(--neutral-white)] border-t border-[var(--neutral-gray)] relative overflow-hidden">
            ...
            <div className="flex gap-6 pt-2">
              {socialLinks.map((social) => (
                <Link
                  ...
                  className="text-[var(--neutral-text-secondary)] hover:text-[var(--neutral-white)] transition-colors duration-200 text-lg hover:scale-110 transform"
      ...
      <div className="py-6 font-light text-center text-xs text-[var(--neutral-text-secondary)]">
        ...
        , este es un prototipo web y no puede ser utilizado como una página
        oficial. Todos los derechos reservados.
      </div>
    </footer>
  );
};
